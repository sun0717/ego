...
// 用type查
// router.get("/backend/itemCategory/selectItemCategoryByParentType", (req, res) => {
...
// router.get("/backend/itemCategory/selectItemCategoryByParentNode", (req, res) => {
//     const cid = req.query.cid || 1;
//     const sql = "select c1.name from category c1,category c2 where c1.type = c2.cid AND c2.cid = ?"
//     var arr = [cid];
//     sqlFn(sql, arr, result => {
//         if (result.length > 0) {
//             res.send({
